...
Implementar e validar um laboratório de SIEM utilizando Wazuh
Manager e Wazuh Agent para monitoramento de eventos de segurança
do Windows.
...
Esta versão representa uma PoC educacional. A expansão para
funcionalidades adicionais está planejada para a V2.
